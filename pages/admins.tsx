...
export default function Admins() {
  ...
  const { pendingValidators, isPendingValidatorsLoading, refetchPendingValidators } =
    usePendingValidators();
  const { stakingParams, isParamsLoading, refetchParams } = useStakingParams();
  const { validators, isActiveValidatorsLoading, refetchActiveValidatorss } = useValidators();
