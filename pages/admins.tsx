...
export default function Admins() {
  ...
  const { stakingParams, isParamsLoading } = useStakingParams();
  ...
  return (
    <div className="max-w-5xl relative py-8 mx-auto">
      ...
      <div className="mt-6 p-4 gap-4 flex flex-col lg:flex-row rounded-md bg-base-300 shadow-lg transition-opacity duration-300 ease-in-out animate-fadeIn">
            ...
            <div className="grid max-w-screen-xl bg-base-100 p-12 rounded-md w-full mx-auto gap-8 lg:grid-cols-12">
              <div className="mr-auto place-self-center lg:col-span-7">
                ...
                <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">
                  Use the button below to connect your wallet and start changing parameters as an
                  admin.
                </p>
        ...
        ) : !isGroupByAdminLoading && !isActiveValidatorsLoading && !isMember ? (
          <div className="flex flex-col w-full bg-base-100 rounded-md p-4 transition-opacity duration-300 ease-in-out animate-fadeIn">
            <div className="flex flex-col w-full h-full gap-4">
              ...
              <p className="text-lg mx-auto text-center max-w-prose">
                You do not have permission to view this page. Only proof of authority administrators
                or members of a group that is a proof of authority admin may access this page.
              </p>
            </div>
          </div>
        ) : (
                ...
                <div className="flex flex-col gap-4 justify-between items-center w-full">
                  ...
                  <div className="flex flex-col md:flex-row gap-4 justify-between items-center w-full">
                    <AdminOptions
                      ...
                      group={group}
                      isLoading={isPoaAdminLoading || isGroupByAdminLoading}
                    />
                    <StakingParams
                      address={address ?? ''}
                      admin={
