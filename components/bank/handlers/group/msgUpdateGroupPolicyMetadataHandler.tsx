  ...
  successSender: tx => {
    ...
    return (
      <span className="flex gap-1">
        You updated the policy metadata of group {groupPolicyAddress}
      </span>
    );
  },
  failSender: tx => {
    ...
    return (
      <span className="flex gap-1">
        You failed to update policy metadata of group {groupPolicyAddress}
      </span>
    );
  },
  successReceiver: tx => {
    ...
    return (
      <span className="flex gap-1">Group {groupPolicyAddress} had its policy metadata updated</span>
    );
  },
});
